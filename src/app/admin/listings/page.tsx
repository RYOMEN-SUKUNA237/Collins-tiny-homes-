                ...
                {listings.length === 0 ? (
                  ...
                  listings.map((listing) => (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-charcoal-light mt-0.5">
                              {listing.location} · {listing.home_type}
                            </p>
                          </div>
                        </div>
                      </td>
                        ...
                        <span
                          className={`inline-block px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wide mb-1 ${
                            listing.price_type === "rent"
                              ...
                              : listing.price_type === "both"
                                ? "bg-gradient-to-r from-sage/20 to-clay/20 text-charcoal"
                      ...
                      <td className="px-4 py-4">
                        {listing.is_featured ? (
                          <span className="px-2.5 py-1 rounded-lg text-xs font-semibold bg-clay/15 text-clay-dark">
                            Featured
                          </span>
                        ) : (
