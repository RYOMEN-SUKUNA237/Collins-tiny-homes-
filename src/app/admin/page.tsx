  ...
  const stats = [
    {
      ...
      value: statsData.totalListings,
      icon: Home,
      color: "bg-sage/10 text-sage-dark",
      detail: `${statsData.activeListings} active`,
    },
    {
      label: "Land Parcels",
      value: statsData.totalLands,
      icon: MapPin,
    ...
    },
    {
      ...
      icon: Users,
      color: "bg-sage/10 text-sage-dark",
      detail: `Out of ${statsData.totalInquiries} total`,
    },
    {
      label: "Finance Apps",
      value: statsData.financeApps,
      icon: DollarSign,
      color: "bg-clay/10 text-clay-dark",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5">
          {stats.map((stat) => {
            ...
            return (
              <div
                key={stat.label}
                className="bg-white rounded-2xl p-6 border border-sage/10 shadow-sm hover:shadow-md transition-shadow duration-200"
              >
                <div
                ...
                <p className="text-3xl font-serif font-bold text-charcoal mb-1">
                  {stat.value}
                </p>
                <p className="text-charcoal-light text-sm font-medium mb-1">
                  {stat.label}
                </p>
